                                ...
                                <table class="table table-striped font-14">
                                    ...
                                    <?php $__currentLoopData = $certificates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $certificate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                <span><?php echo e($certificate->webinar->title); ?></span>
                                            </td>
                                            <td class="text-left"><?php echo e($certificate->student->full_name); ?></td>
                                            <td class="text-left"><?php echo e($certificate->webinar->teacher->full_name); ?></td>

                                            <td class="text-center"><?php echo e(dateTimeFormat($certificate->created_at, 'j M Y')); ?></td>

                                            <td>
                                                <a href="/admin/certificates/<?php echo e($certificate->id); ?>/download" target="_blank" class="btn-transparent text-primary" data-toggle="tooltip" title="<?php echo e(trans('quiz.download_certificate')); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/edutech/resources/views/admin/certificates/course_certificates.blade.php ENDPATH**/ ?>